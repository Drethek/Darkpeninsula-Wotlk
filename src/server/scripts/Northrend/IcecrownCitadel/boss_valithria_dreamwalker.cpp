            ...
            void SpellHit(Unit* /*caster*/, SpellInfo const* spell)
            {
                if (spell->Id == SPELL_DREAM_SLIP)
                {
                    ...
                    if (Creature* lichKing = ObjectAccessor::GetCreature(*me, _instance->GetData64(DATA_VALITHRIA_LICH_KING)))
                        ...
                        me->SummonGameObject(RAID_MODE(GO_CACHE_OF_THE_DREAMWALKER_10_N,GO_CACHE_OF_THE_DREAMWALKER_25_N,GO_CACHE_OF_THE_DREAMWALKER_10_H,GO_CACHE_OF_THE_DREAMWALKER_25_H), me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), me->GetOrientation(), 0, 0, 0, 0, 90000000);
