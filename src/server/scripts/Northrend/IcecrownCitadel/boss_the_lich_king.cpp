    ...
    public:
        ...
        struct boss_the_lich_kingAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/)
            {
                ...
                //instance->DoCompleteAchievement(RAID_MODE(ACHIEV_THE_FROZEN_THRONE_10, ACHIEV_BANE_OF_THE_FALLEN_KING, ACHIEV_THE_FROZEN_THRONE_25, ACHIEV_THE_LIGHT_OF_DAWN));

                if (instance->GetData(DATA_BEEN_WAITING_ACHIEVEMENT) == DONE)
                    DoCompleteAchievement(RAID_MODE(ACHIEV_BEEN_WAITING_A_LONG_TIME_FOR_THIS_10,ACHIEV_BEEN_WAITING_A_LONG_TIME_FOR_THIS_25));

                if (instance->GetData(DATA_NECK_DEEP_ACHIEVEMENT) == DONE)
                    DoCompleteAchievement(RAID_MODE(ACHIEV_NECK_DEEP_IN_VILE_10,ACHIEV_NECK_DEEP_IN_VILE_25));
...
class npc_tirion_icc : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if ( (instance->GetBossState(DATA_PROFESSOR_PUTRICIDE) == DONE) && (instance->GetBossState(DATA_SINDRAGOSA) == DONE) && 
                 (instance->GetBossState(DATA_BLOOD_QUEEN_LANA_THEL) == DONE) && (instance->GetBossState(DATA_DEATHBRINGER_SAURFANG) == DONE) )
            {
    ...
    public:
        ...
        class spell_lich_king_pain_and_suffering_effect_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                ...
                //OnEffectHitTarget += SpellEffectFn(spell_lich_king_pain_and_suffering_effect_SpellScript::HandleScript, EFFECT_1, SPELL_EFFECT_SCHOOL_DAMAGE);
            }
        };
    ...
    public:
        ...
        class spell_lich_king_necrotic_plague_AuraScript : public AuraScript
        {
            ...
            /*void OnPeriodic(AuraEffect const*aurEff)
            {
                ...
                GetCaster()->DealDamage(GetTarget(), (uint32)aurEff->GetBaseAmount() * m_stackAmount, 0, SPELL_DIRECT_DAMAGE, SPELL_SCHOOL_MASK_SHADOW, aurEff->GetSpellInfo(), true);
                //if (GetTarget() && GetTarget()->isAlive() && GetCaster() && GetCaster()->isAlive())
    ...
    public:
        ...
        class spell_lich_king_tirion_mass_resurrection_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                ...
                //OnEffectHitTarget += SpellEffectFn(spell_lich_king_tirion_mass_resurrection_SpellScript::MassResurrect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
