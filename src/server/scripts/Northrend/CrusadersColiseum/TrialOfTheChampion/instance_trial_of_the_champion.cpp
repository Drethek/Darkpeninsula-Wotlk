...
public:
    ...
    struct instance_trial_of_the_champion_InstanceMapScript : public InstanceScript
    {
        ...
        uint64 uiGrandChampionVehicle1Entry;
        uint64 uiGrandChampionVehicle2Entry;
        uint64 uiGrandChampionVehicle3Entry;
        ...
        void Initialize()
        {
            ...
            uiGrandChampionVehicle1Entry  = 0;
            uiGrandChampionVehicle2Entry  = 0;
            uiGrandChampionVehicle3Entry  = 0;
    ...
    void AggroAllPlayers(Creature* pTemp)
    {
        ...
        uint64 GetData64(uint32 uiData)
        {
            switch (uiData)
            {
                ...
                case DATA_GRAND_CHAMPION_VEHICLE_ENTRY_1: return uiGrandChampionVehicle1Entry;
                case DATA_GRAND_CHAMPION_VEHICLE_ENTRY_2: return uiGrandChampionVehicle2Entry;
                case DATA_GRAND_CHAMPION_VEHICLE_ENTRY_3: return uiGrandChampionVehicle3Entry;
            }
        ...
        void SetData64(uint32 uiType, uint64 uiData)
        {
            switch (uiType)
            {
                ...
                case DATA_GRAND_CHAMPION_VEHICLE_3:
                    ...
                    break;
                case DATA_GRAND_CHAMPION_VEHICLE_ENTRY_1:
                    uiGrandChampionVehicle1Entry = uiData;
                    break;
                case DATA_GRAND_CHAMPION_VEHICLE_ENTRY_2:
                    uiGrandChampionVehicle2Entry = uiData;
                    break;
                case DATA_GRAND_CHAMPION_VEHICLE_ENTRY_3:
                    uiGrandChampionVehicle3Entry = uiData;
                    break;
            }
        }
