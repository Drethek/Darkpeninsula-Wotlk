...
const Position ToCCommonLoc[]=
{
    ...
    {563.5f, 183.5f, 394.52f, 0},               //  5 - Center
...
{
    {541.021118f, 117.262932f, 395.314819f, 0}, // 0 - Light essence 1
    {586.200562f, 162.145523f, 394.626129f, 0}, // 1 - Light essence 2
    {586.060242f, 117.514809f, 394.314026f, 0}, // 2 - Dark essence 1
    {541.602112f, 161.879837f, 394.587952f, 0}, // 3 - Dark essence 2
};
...
const Position EndingSpawnLoc[]=
{
    {622.716f, 137.627f, 140.014f, 6.26932f},  // 0 - Tirion Spawn
    {622.581f, 127.851f,  139.94f, 6.26932f},  // 1 - Tribute Chest Spawn
    {622.842f, 146.656f, 140.148f, 6.26932f},  // 2 - Dalaran Portal Spawn
};
