...
enum BossSpells
{
    ...
    SPELL_SWEEP_1           = 67646,
    SPELL_EMERGE_0          = SPELL_EMERGE,
    SPELL_SUBMERGE_0        = SPELL_SUBMERGE,
    SPELL_ENRAGE            = 68335,
...
struct boss_jormungarAI : public ScriptedAI
{
    ...
    Creature* GetSister()
    {
        return Unit::GetCreature((*me), instanceScript->GetData64(otherWormEntry));
    }
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        switch (stage)
        {
            ...
            case 2: // Wait til emerge
                ...
                break;
            case 3: // Emerge
                me->SetNativeDisplayId(modelStationary);
            ...
            case 6: // Wait til emerge
                ...
                break;
            case 7: // Emerge
                me->SetNativeDisplayId(modelMobile);
                DoScriptText(SAY_EMERGE, me);
                me->RemoveAurasDueToSpell(SPELL_SUBMERGE_0);
                DoCast(me, SPELL_EMERGE_0);
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE);
