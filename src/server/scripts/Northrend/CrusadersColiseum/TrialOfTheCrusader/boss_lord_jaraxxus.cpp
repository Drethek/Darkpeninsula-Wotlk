...
enum BossSpells
{
    ...
    SPELL_SUMMON_PORTAL               = 66269,
    SPELL_INFERNAL_ERUPTION           = 66252,
...
public:
    ...
    struct boss_jaraxxusAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            m_uiTouchOfJaraxxusTimer = urand(25*IN_MILLISECONDS, 35*IN_MILLISECONDS);
    ...
    public:
        ...
        void CalcDamage(SpellEffIndex /*effIndex*/)
        {
            ...
            if(Unit* pTarget = GetHitUnit())
                dmg = pTarget->GetMaxHealth()*50.0f/100.0f;
            SetHitDamage(dmg);
        }
