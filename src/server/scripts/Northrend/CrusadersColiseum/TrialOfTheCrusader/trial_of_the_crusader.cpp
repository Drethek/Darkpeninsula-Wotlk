                ...
                if (m_uiUpdateTimer <= uiDiff)
                {
                    switch (m_instance->GetData(TYPE_EVENT))
                    {
                        ...
                        case 5060:
                            ...
                            break;
                        case 5070:
                            me->CastSpell(me, SPELL_FROST_NOVA_VISUAL, false);
                ...
                if (m_uiUpdateTimer <= uiDiff)
                {
                    switch (m_instance->GetData(TYPE_EVENT))
                    {
                        ...
                        case 1150:
                            ...
                            {
                                //1-shot Fizzlebang
                                temp->CastSpell(me, SPELL_FEL_LIGHTNING, false);
                ...
                if (m_uiUpdateTimer <= uiDiff)
                {
                    switch (m_instance->GetData(TYPE_EVENT))
                    {
                        ...
                        case 5020:
                            ...
                            break;
                        case 6000:
                            me->NearTeleportTo(EndingSpawnLoc[0].GetPositionX(), EndingSpawnLoc[0].GetPositionY(), EndingSpawnLoc[0].GetPositionZ(), EndingSpawnLoc[0].GetOrientation());
                            m_uiUpdateTimer = 20000;
                        ...
                        case 6010:
                            ...
                            break;
                        case 6020:
                            me->SummonGameObject(202079, EndingSpawnLoc[2].GetPositionX(), EndingSpawnLoc[2].GetPositionY(), EndingSpawnLoc[2].GetPositionZ(), EndingSpawnLoc[2].GetOrientation(), 0, 0, 1, 1, 604800);
                            m_uiUpdateTimer = 5000;
