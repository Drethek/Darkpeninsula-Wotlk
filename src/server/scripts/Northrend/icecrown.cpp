...
enum eValiantText
{
    NPC_FACTION_VAILIANT_TEXT_SAY_START_1     = -1850004, // Get ready!
    NPC_FACTION_VAILIANT_TEXT_SAY_START_2     = -1850005, // The battle begin!
    NPC_FACTION_VAILIANT_TEXT_SAY_START_3     = -1850006, // Get ready!
    NPC_ARGENT_VAILIANT_TEXT_SAY_START        = -1850007, // You think you have the courage in you? We'll see.
    NPC_ARGENT_VAILIANT_TEXT_SAY_WIN          = -1850008, // Impressive display. I think you are quite able to join the ranks of the brave.
    NPC_ARGENT_VAILIANT_TEXT_SAY_LOOSE        = -1850009, // I won. You will probably have more luck next time.
    NPC_FACTION_VAILIANT_TEXT_SAY_WIN_1       = -1850010, // I am defeated. Nice fight!
    NPC_FACTION_VAILIANT_TEXT_SAY_WIN_2       = -1850011, // Looks like I underestimated your skills. Well done.
    NPC_FACTION_VAILIANT_TEXT_SAY_LOOSE       = -1850012, // I won. You will probably have more luck next time.
};
...
#define GOSSIP_HELLO_JERAN_1 "Show me how to train on a melee target."
#define GOSSIP_HELLO_JERAN_2 "Tell me about defense and spear."
...
#define GOSSIP_HELLO_RUGAN_1 "Show me how to train on a Charge Target."
#define GOSSIP_HELLO_RUGAN_2 "Tell me about the charge."
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
    {
        ...
        {
            player->CLOSE_GOSSIP_MENU();
            creature->SummonCreature(NPC_ARGENT_CHAMPION,8562.836914,1099.153931,556.787598,5.026550); // TODO (Récupérer les coordonnées réelles)
        }
        //else
            //player->SEND_GOSSIP_MENU(???, creature->GetGUID()); Missing text
        return true;
...
enum eChampionText
{
    NPC_FACTION_CHAMPION_TEXT_SAY_START_1     = -1850004, // Get ready!
    NPC_FACTION_CHAMPION_TEXT_SAY_START_2     = -1850005, // The battle begin!
    NPC_FACTION_CHAMPION_TEXT_SAY_START_3     = -1850006, // Get ready!
    NPC_ARGENT_CHAMPION_TEXT_SAY_START        = -1850007, // You think you have the courage in you? We'll see.
    NPC_ARGENT_CHAMPION_TEXT_SAY_WIN          = -1850008, // Impressive display. I think you are quite able to join the ranks of the brave.
    NPC_ARGENT_CHAMPION_TEXT_SAY_LOOSE        = -1850009, // I won. You will probably have more luck next time.
    NPC_FACTION_CHAMPION_TEXT_SAY_WIN_1       = -1850010, // I am defeated. Nice fight!
    NPC_FACTION_CHAMPION_TEXT_SAY_WIN_2       = -1850011, // Looks like I underestimated your skills. Well done.
    NPC_FACTION_CHAMPION_TEXT_SAY_LOOSE       = -1850012, // I won. You will probably have more luck next time.
};
...
public:
    ...
    struct npc_argent_championAI : public ScriptedAI
    {
        npc_argent_championAI(Creature* creature) : ScriptedAI(creature)
        {
            ...
            me->CastSpell(me, SPELL_DEFEND_CHAMPION, true);
            creature->GetMotionMaster()->MovePoint(0,8552.469727,1124.128784,556.787598);
            creature->setFaction(35); //wrong faction in db?
        }
