...
bool Master::_StartDB()
{
    ...
    synch_threads = ConfigMgr::GetIntDefault("LogDatabase.SynchThreads", 2);
    ...
    dbstring = ConfigMgr::GetStringDefault("ExtraDatabaseInfo", "");
    if (dbstring.empty())
    {
    ...
    async_threads = ConfigMgr::GetIntDefault("ExtraDatabase.WorkerThreads", 1);
    if (async_threads < 1 || async_threads > 32)
    {
    ...
    synch_threads = ConfigMgr::GetIntDefault("ExtraDatabase.SynchThreads", 2);
