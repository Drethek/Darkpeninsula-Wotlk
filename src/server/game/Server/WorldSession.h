...
class WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleInstanceLockResponse(WorldPacket& recvPacket);
         ...
         // Wintergrasp PvP Event
        void HandleBattleFieldInviteResponse(WorldPacket &recv_data);
        void HandleQueueInviteResponse(WorldPacket &recv_data);
        void HandleQueueExitRequest(WorldPacket &recv_data);
