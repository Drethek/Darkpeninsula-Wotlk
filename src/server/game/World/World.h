...
enum WorldBoolConfigs
{
    ...
    CONFIG_ARENA_QUEUE_ANNOUNCER_ARENA_CHANNEL_ONLY,
    ...
    // Custom Logs By Darkpeninsula
    CONFIG_LOGS_ITEMS_ENABLE,
    CONFIG_LOGS_KILL_ENABLE,
    CONFIG_BATTLEGROUND_MOD_ENABLE,
...
enum WorldIntConfigs
{
    ...
    // Custom Logs By Darkpeninsula
    CONFIG_LOGS_ITEMS_LEVEL,
    CONFIG_LOGS_ITEMS_QUALITY,
    CONFIG_LOGS_KILL_RANK,
    CONFIG_LOGS_KILL_LEVEL,
    CONFIG_BALANCE_MINIMUM,

    // Custom Mods By Darkpeninsula
    CONFIG_BATTLEGROUND_MOD_AV,
    CONFIG_BATTLEGROUND_MOD_WS,
    CONFIG_BATTLEGROUND_MOD_AB,
    CONFIG_BATTLEGROUND_MOD_EY,
    CONFIG_BATTLEGROUND_MOD_SA,
    CONFIG_BATTLEGROUND_MOD_IC,
...
class World
{
    public:
        ...
        void SendArenaAnnounceText(int32 string_id, ...);
        ...
        void SetWintergrapsTimerToJoin(uint32 CanJoin)
        {
            m_StartJoin = CanJoin;
        }

        uint32 GetWintergrapsTimerToJoin() { return m_StartJoin; }
        uint32 m_StartJoin;
