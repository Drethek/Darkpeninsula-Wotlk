            ...
            case SPELLFAMILY_GENERIC:
            {
                ...
                switch (m_spellInfo->Id)                     // better way to check unknown
                {
                    ...
                    case 62307: //Hurl Boulder
                    {
                        ...
                        {
                            if(unitTarget->GetGUID() == m_caster->GetGUID() || unitTarget->GetTypeId() == TYPEID_PLAYER || unitTarget->IsFriendlyTo(m_caster))
                            {
                                damage = 0;
                                break;
                            }
        ...
        case SPELLFAMILY_GENERIC:
        {
            switch (m_spellInfo->Id)
            {
                ...
                case 54171:                                   //Divine Storm
                {
                    ...
                    {
                        SpellInfo const *pSpellInfo = sSpellMgr->GetSpellInfo(53385);
                        int32 heal = pSpellInfo->Effects[EFFECT_1].CalcValue() * damage / m_UniqueTargetInfo.size() / 100;
